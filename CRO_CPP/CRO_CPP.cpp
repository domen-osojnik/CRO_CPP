    ...
    for (int in = 0; in < 32; in++)
    {
        ...
        double energy[NR]; // Vector of size NR
        {
            ...
            for (int i = 0; i < NR; i++)
            {
                ...
                std::cout << "Time taken = " << (tempTime1 / 1000) << "\n";
            ...
            std::cout << "Total execution time: " << executionTime << "\n";
            std::cout << "---------------------- " << dataSet[in] << " ------------------------\n";

            std::cout << "Ebest = " << eBest << "      Emean = " << eMean << "      Std = " << eStd << "\n";
            std::cout << "div = " << div << "    speed = " << pSpeed << "     SR =  " << (NSR / NR) << "\n";
